 ...
 * @author Eva
 */
public class DeepMixNN_Regression_DX implements IDeepMixNN_Regression {
    ...
    // Создание новой сети
    public DeepMixNN_Regression_DX (int inputs) {
    ...
    public DeepMixNN_Regression_DX (int inputs, String path) throws IOException {
    ...
    public void putData (QDataset qds) {
        ...
        for (int st = 0; st < qds.getQStates().size(); st++) {
            ...
            for (int ln = 0; ln < lengthOfHistory; ln++) {
                ...
                feturesAll.putScalar(0, 0, 0, ln, (qds.getQStates().get(st).getSeries().get(ln +1).getAdxPlus_3() - qds.getQStates().get(st).getSeries().get(ln +1).getAdxMinus_3()) / 100);
                feturesAll.putScalar(0, 0, 1, ln, (qds.getQStates().get(st).getSeries().get(ln +1).getAdxPlus_7() - qds.getQStates().get(st).getSeries().get(ln +1).getAdxMinus_7()) / 100);
                feturesAll.putScalar(0, 0, 2, ln, (qds.getQStates().get(st).getSeries().get(ln +1).getAdxPlus_13() - qds.getQStates().get(st).getSeries().get(ln +1).getAdxMinus_13()) / 100);
                feturesAll.putScalar(0, 0, 3, ln, (qds.getQStates().get(st).getSeries().get(ln +1).getAdxPlus_21() - qds.getQStates().get(st).getSeries().get(ln +1).getAdxMinus_21()) / 100);
                feturesAll.putScalar(0, 0, 4, ln, (qds.getQStates().get(st).getSeries().get(ln +1).getAdxPlus_31() - qds.getQStates().get(st).getSeries().get(ln +1).getAdxMinus_31()) / 100);
            }
    ...
    public double prediction (QState qs) {
        ...
        for (int ln = 0; ln < lengthOfHistory; ln++) {
            // ЗАПОЛНЯЕМ ВХОДНЫЕ ДАННЫЕ
            feturesAll.putScalar(0, 0, 0, ln, (qs.getSeries().get(ln +1).getAdxPlus_3() - qs.getSeries().get(ln +1).getAdxMinus_3())/ 100);
            feturesAll.putScalar(0, 0, 1, ln, (qs.getSeries().get(ln +1).getAdxPlus_7() - qs.getSeries().get(ln +1).getAdxMinus_7())/ 100);
            feturesAll.putScalar(0, 0, 2, ln, (qs.getSeries().get(ln +1).getAdxPlus_13() - qs.getSeries().get(ln +1).getAdxMinus_13())/ 100);
            feturesAll.putScalar(0, 0, 3, ln, (qs.getSeries().get(ln +1).getAdxPlus_21() - qs.getSeries().get(ln +1).getAdxMinus_21())/ 100);
            feturesAll.putScalar(0, 0, 4, ln, (qs.getSeries().get(ln +1).getAdxPlus_31() - qs.getSeries().get(ln +1).getAdxMinus_31())/ 100);
        }
